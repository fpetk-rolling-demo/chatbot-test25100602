...
!!! info
    ...
    **Source Code Repository:** [https://github.com/fpetk-rolling-demo/chatbot-test25100602](https://github.com/fpetk-rolling-demo/chatbot-test25100602)

    **GitOps Repository:** [https://github.com/fpetk-rolling-demo/chatbot-test25100602-gitops](https://github.com/fpetk-rolling-demo/chatbot-test25100602-gitops)

# **Usage**

To access the chatbot-test25100602 application that was deployed using the Software Template, complete the following instructions:
